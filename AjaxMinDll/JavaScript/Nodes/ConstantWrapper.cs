...
namespace Microsoft.Ajax.Utilities.JavaScript.Nodes
{
    ...
    public class ConstantWrapper : Expression
    {
        ...
        //        case PrimitiveType.Number:
        //            if (Object.ReferenceEquals(Context, null) || Parser.Settings.IsModificationAllowed(TreeModifications.MinifyNumericLiterals))
        //            {
        ...
        //        case PrimitiveType.String:
        //            if (Object.ReferenceEquals(Context, null) || Parser.Settings.IsModificationAllowed(TreeModifications.MinifyStringLiterals))
        //            {
        //                // escape the string
        //                str = EscapeString(
        //                    Value.ToString(),
        //                    IsParameterToRegExp, 
        //                    false,
        //                    EnclosingLexicalEnvironment.UseStrict);
        //            }
        //            else
        //            {
        //                // just use the original literal from the context
        ...
        //        if (!Object.ReferenceEquals(this.Context, null) && !string.IsNullOrEmpty(Context.Code)
