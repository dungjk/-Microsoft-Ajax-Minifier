    ...
    public class CommandLine
    {
        ...
        public void ToSettings()
        {
            var testData = new ArgumentsSettings[] {
                ...
                new ArgumentsSettings(){CommandLine="-l -z -hCL", JSSettings=new CodeSettings() {CollapseToLiteral=false, TermSemicolons=true, CombineDuplicateLiterals=false, LocalRenaming=LocalRenaming.KeepLocalizationVars}, CssSettings=null},
                new ArgumentsSettings(){CommandLine="/HC", JSSettings=new CodeSettings() {CombineDuplicateLiterals=false}, CssSettings=null},
