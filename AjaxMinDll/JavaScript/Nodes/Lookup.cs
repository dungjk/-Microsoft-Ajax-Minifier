    ...
    public sealed class Lookup : Expression
    {
        ...
        public Binding Binding
        {
            get
            {
                ...
                if (Reference != null && Reference.Base != null)
                {
                    Reference.Base.TryGetBinding(Reference.Name, out binding);
                }
                return binding;
            }
        }
        ...
        public override bool IsEquivalentTo(AstNode otherNode)
        {
            ...
            if (otherLookup != null)
            {
                ...
                if (binding != null)
                {
                    ...
                    return binding == otherLookup.Binding;
                }
                else
                {
